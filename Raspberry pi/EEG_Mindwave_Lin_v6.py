...
###################################################
#Configuraci[on de GPIO para alerta visible y/o audible
...
##def Apagar(bot):
##    #Apagar raspberry pi
##    os.system("espeak -ves -s300 'Apagando sistema'") #Solo para sistemas con espeak instalado de lo contrario comentar
##                   
##    os.system("sudo shutdown -h now")
##
##GPIO.add_event_callback(21,Apagar)
##################################################
        ...
        while(True):
            try:
                ...
                if intento>5:
                    ...
                    os.system("espeak -ves -s300 'Saliendo de sistema'") #Solo para sistemas con espeak instalado de lo contrario comentar
                    break
...
class MindwaveDataPointReader:
    ...
    def _readDataPointsFromOnePacket(self):
        ...
        if (not self._checkSumIsOk(payloadBytes, checkSum)):
            ...
            if Err<10:
                print "Cambiar baterias"
                os.system("espeak -ves -s300 'Cambia de baterias y reinicia'") #Solo para sistemas con espeak instalado de lo contrario comentar
